...
// 반올림
let round;
console.log('floor: ', Math.round(number));
...
// 절삭(소수점 이하)
let truncate;
console.log('truncate: ', Math.trunc(number));
...
// 여러 수 중, 최댓값
let max;
console.log('max: ', Math.max(30, 50));

// 여러 수 중, 최솟값
let min;
console.log('min: ', Math.min(30, 50));
...
const getRandomMinMax = (minimum, maximum) => {
...
//눈내리는  hello
// setInterval(() => {
//   const id = (document.querySelector('.first').style.transform = `translate(${
//     Math.sin(++count) * 10
